...
<body>
	<section class="page flex">
		...
		<div class="form__logo flex">
			<svg class="icy__icon" width="24" height="24" viewBox="0 0 24 24" version="1.1" id="svg1" sodipodi:docname="iCy.svg" xml:space="preserve" inkscape:export-filename="brand\black_normal.svg" inkscape:export-xdpi="96" inkscape:export-ydpi="96" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
			<defs id="defs1"></defs>
